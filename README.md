...
![WhatsApp Web API](https://raw.githubusercontent.com/JackPro-12/Jack-baileys/refs/heads/master/images/image.png)

</div>

![Repo Size](https://img.shields.io/github/repo-size/JackPro-12/Jack-baileys)
![Stars](https://img.shields.io/github/stars/JackPro-12/Jack-baileys?style=social)
![Forks](https://img.shields.io/github/forks/JackPro-12/Jack-baileys?style=social)
![Watchers](https://img.shields.io/github/watchers/JackPro-12/Jack-baileys?style=social)
![Last Commit](https://img.shields.io/github/last-commit/JackPro-12/Jack-baileys)
![Issues](https://img.shields.io/github/issues/JackPro-12/Jack-baileys)
![License](https://img.shields.io/github/license/JackPro-12/Jack-baileys)
...
```bash
npm install github:JackPro-12/Jack-baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add github:JackPro-12/Jack-baileys
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@JackPro-12/Jack-baileys")
```
...
```javascript
const makeWASocket = require("@JackPro-12/Jack-baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@JackPro-12/Jack-baileys");
...
```javascript
const makeWASocket = require("@JackPro-12/Jack-baileys").default;
const { makeInMemoryStore } = require("@JackPro-12/Jack-baileys");
...
const { downloadMediaMessage, getContentType } = require("@JackPro-12/Jack-baileys");
